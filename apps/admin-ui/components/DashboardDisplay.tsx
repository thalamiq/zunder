...
import { getQueueHealth, listJobs } from "@/lib/api/jobs";
...
const DashboardDisplay = () => {
  ...
  const handleApiRequest = (e?: React.FormEvent) => {
    ...
    router.push(`${config.nav.api.path}?endpoint=${encodedEndpoint}`);
    ...
    <div className="space-y-6 p-6">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => router.push(config.nav.api.path)}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card
          ...
          onClick={() => router.push(config.nav.resources.path)}
        >
        ...
        <Card
          className="cursor-pointer hover:bg-accent/50 transition-colors"
          onClick={() => router.push(config.nav.jobs.path)}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card
          className="cursor-pointer hover:bg-accent/50 transition-colors"
          onClick={() => router.push(config.nav.packages.path)}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">

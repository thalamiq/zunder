...
<CardGroup cols={2}>
  <Card title="CRUD Operations" icon="pen" href="/server/crud-operations">
    Learn about create, read, update, delete
  </Card>
  <Card
    title="Batch & Transaction"
    icon="layer-group"
    href="/server/batch-and-transactions"
  >
  ...
  <Card title="Search" icon="magnifying-glass" href="/server/search">
